...
"""
Image Build Manager — Common Variables

All constants, paths, container names, commands, and defaults used
across the test automation framework.
"""
...
# =============================================================================
# REMOTE CLONE DEFAULTS
# =============================================================================

DEFAULT_CLONE_URL = (
    "https://github.com/abhishek-sa1/image-build-manager.git"
)
DEFAULT_CLONE_PATH = "/root/image-build-manager"

# =============================================================================
# PLAYBOOK CONFIGURATION
# =============================================================================

# Playbook entry point (relative to src/)
PLAYBOOK_ENTRY_POINT = "image_build_manager.yml"
PLAYBOOK_WORKDIR = "src"
...
DEFAULT_DATASET = "project_default"

# Dataset directory layout
DATASET_INPUT_DIR = "input"
DATASET_CONFIG_FILE = "config.yml"
