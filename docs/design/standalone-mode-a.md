# Image Build Manager — Mode A (Bare-Metal) Design

## Status: ACTIVE v1.0

This document describes how `image_build_manager` operates in **Mode A** — directly on a
...
```yaml
repo_manager_output_dir: "/opt/omnia/repo_manager/output/repo_status.yml"
```
...
# Development: edit src/input/project_default/repo_manager_output/repo_status.yml
#              and update repo_manager_output_dir in image_build_config.yml
...
## 8. Container Files (Kept, Not Required)
